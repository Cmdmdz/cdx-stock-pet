                ...
                <div class="col-12">
                                ...
                                @foreach ($order->orderItems as $item)
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img class="fit-image"
                                                    src="{{ asset($item->product->image) }}" alt="Product" /></a></td>
                                        <td class="pro-title"><a href="#">{{ $item->product->name }}</a></td>
                                        <td class="pro-price"><span>${{ number_format($item->product->price, 2) }}</span>
                                        </td>
                                        ...
                                        <td class="pro-subtotal">
                                            <span>${{ number_format($item->order->total_price, 2) }}</span></td>
                    ...
                    <div class="cart-button-section mb-n4">
                        ...
                        <div class="cart-btn-lef-side mb-4">
                            <a href="{{route('customer.view')}}" class="btn btn btn-gray-deep btn-hover-primary">Continue Shopping</a>
            ...
            <div class="row mt-10">
                <div class="col-lg-6 me-0 ms-auto">
                    ...
                    <div class="cart-calculator-wrapper">
                        ...
                        <a href="checkout.html" class="btn btn btn-gray-deep btn-hover-primary mt-6">Proceed To
                            Checkout</a>
